...
export default function Contact() {
    return (
        <div className="p-6 max-w-md mx-auto">
            ...
            <input type="text" placeholder="نام و نام خانوادگی" className="border border-gray-300 rounded-lg p-3 w-full mt-6 mb-4 text-black" />
            <input type="tel" placeholder="شماره موبایل" className="border border-gray-300 rounded-lg p-3 w-full mb-4 text-black" />
            <textarea placeholder="متن پیام" rows={4} className="border border-gray-300 rounded-lg p-3 w-full mb-4 text-black" />
